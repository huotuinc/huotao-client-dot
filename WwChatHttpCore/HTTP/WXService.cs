...
namespace WwChatHttpCore.HTTP
{
    ...
    public class WXService
    {
        ...
        /// </summary>
        /// <returns></returns>
        private string GetURLGetMsgImg()
        {
            return "https://" + WeixinRouteHost + "/cgi-bin/mmwebwx-bin/webwxgetmsgimg";
        }
        ...
        public void SendImageToUserName(string userName, string imageName, Stream stream)
        {
            try
            {
                string from = myUserName();
                string mediaId = SendImageToUserName(userName, from, imageName, stream);
        ...
        {
            return BaseService.SendGetRequest(GetURLGetMsgImg() + "?MsgID=" + msgid + "&skey=" + LoginService.SKey);
        }
