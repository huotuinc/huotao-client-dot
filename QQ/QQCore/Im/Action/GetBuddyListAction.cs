...
namespace iQQ.Net.WebQQCore.Im.Action
{
    ...
    public class GetBuddyListAction : AbstractHttpAction
    {
        ...
        public GetBuddyListAction(IQQContext context, QQActionListener listener) : base(context, listener) { }
        ...
        public override void OnHttpStatusOK(QQHttpResponse response)
        {
            ...
            if (retcode == 0)
            {
                ...
                //好友列表加载完成
                Context.FireNotify(new QQNotifyEvent(QQNotifyEventType.LoadBuddySuccess));
            }
            else
            {
